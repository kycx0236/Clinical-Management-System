...
async function handleFormSubmission() {
    ...
    if (isDateAppointmentValid && isTimeAppointmentValid && isFirstNameValid && isMiddleNameValid && isLastNameValid && isSexValid && isDateOfBirthValid && isContactNumberValid && isEmailValid && isAddressValid && isDoctorIDValid && isDoctorNameValid && isReceptionistIDValid) {
        ...
        try {
            ...
            const response = await fetch('/doctor/add-appointment/', {
                method: 'POST',
